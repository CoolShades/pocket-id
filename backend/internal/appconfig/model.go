...
type AppConfigModel struct {
	...
	// Dynamic background
	DynamicBackgroundEnabled      AppConfigValue `json:"dynamicBackgroundEnabled" type:"bool" public:"true"`
	DynamicBackgroundTheme        AppConfigValue `json:"dynamicBackgroundTheme" public:"true"`
	DynamicBackgroundSeed         AppConfigValue `json:"dynamicBackgroundSeed" type:"int" public:"true"`
	DynamicBackgroundDensity      AppConfigValue `json:"dynamicBackgroundDensity" public:"true"`
	DynamicBackgroundFlowSpeed    AppConfigValue `json:"dynamicBackgroundFlowSpeed" public:"true"`
	DynamicBackgroundNoiseScale   AppConfigValue `json:"dynamicBackgroundNoiseScale" public:"true"`
	DynamicBackgroundTurbulence   AppConfigValue `json:"dynamicBackgroundTurbulence" public:"true"`
	DynamicBackgroundTrailFade    AppConfigValue `json:"dynamicBackgroundTrailFade" public:"true"`
	DynamicBackgroundParticleSize AppConfigValue `json:"dynamicBackgroundParticleSize" public:"true"`
	// Email
